...
inputDireccion.addEventListener("input", async function () {
    ...
    const url =
        `https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(texto)}&limit=5&countrycodes=es`;
